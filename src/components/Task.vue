<template>
  <div id="tasks">
    ...
    <div class="tasks-scroll">
      <div class="addTask">
        <div class="addTask-meta invisible transparent"></div>
        <a class="plus-wrapper"></a>
        <input type="text" class="addTask-input chromeless" placeholder="添加任务...">
        <a class="speech-wrapper"></a>
      </div>
...
<style scoped>
#tasks{position: relative; display: flex; flex-direction: column;}
...
.action-bar-top{position: absolute; width: 250px; height: 324px; right: 0; top: 45px; transition: height 120ms linear; z-index: 1; background: #0e91c5; overflow: hidden; }
